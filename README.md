...
Welcome to my professional portfolio on GitHub! Here, you'll find projects that showcase my expertise in Data Science and Machine Learning, reflecting my journey through the world of data analytics.
...
### 🛰️ Master Research Project in Computer Vision : 6D pose estimator for spacecraft images  
Semester project conducted at CVLAB (EPFL) with the aim to explore how well Vision Transformers can do 6D-pose estimation on spacecraft images (SPEED dataset) and compare them with more classical PnP based techniques.
